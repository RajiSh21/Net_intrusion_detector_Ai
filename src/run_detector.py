"""
NIDS Live Intrusion Detector
============================
Loads the ONCE-TRAINED model and runs live packet capture to detect intrusions.
No training — purely detection.

Usage:
    python run_detector.py                          # Live capture on default interface
    python run_detector.py --interface eth0          # Specific interface
    python run_detector.py --pcap captured.pcap      # Analyze PCAP file instead
    python run_detector.py --count 100               # Stop after 100 flows
    python run_detector.py --alert-only              # Show only intrusion alerts
